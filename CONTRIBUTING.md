# Contributing to hsdp-function-gateway

We'd love for you to contribute to our source code and to make the hsdp-function-gateway even better than it is today!
...
In Github, send a pull request to original main branch: f.e. `hsdp-function-gateway:main`.
...
[github]: https://github.com/philips-labs/hsdp-function-gateway/issues 
